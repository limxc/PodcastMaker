...
import { z } from "zod";
import { Video as AiAgentVideo } from "./AiAgentEraTechProfessionalsVideo";
...
export const RemotionRoot = () => {
  return (
    <>
      {/* 主视频 - AiAgentEraTechProfessionals - 4K 分辨率 */}
      <Composition
        id="AiAgentEraTechProfessionals"
      ...
      {/* Vertical video - 9:16 竖屏版 */}
      <Composition
        id="AiAgentEraTechProfessionalsVertical"
        component={AiAgentVideo}
        durationInFrames={300}
        calculateMetadata={calculateVideoMetadata}
        fps={30}
